...
If you installed confluent-3.0.1-2.11.8 or confluent-3.0.1-2.10.6 (through ZIP, TAR, DEB or RPM), then Support Metrics is already installed and the next step is to obtain your Confluent customer ID from our customer support and to update it in Kafka configuration (see :ref:`ps-customer-id-configuration`).

If you installed confluent-oss-3.0.1-2.11.8 or confluent-oss-3.0.1-2.10.6, or if you chose to install individual packages, you will need to install confluent-support-metrics_3.0.1 packages first.
...
.. sourcecode:: bash
      ...
      $ sudo apt-get update && sudo apt-get install confluent-support-metrics_3.0.1
