...
public class CollectorFactory {
    ...
    private static CollectorConstructorSupplier basicCollectorSupplier = new CollectorFactory.CollectorConstructorSupplier(new CollectorFactory.ConstructorSupplier() {
        @Override
    ...
    private static CollectorConstructorSupplier fullCollectorSupplier = new CollectorFactory.CollectorConstructorSupplier(new CollectorFactory.ConstructorSupplier() {
        @Override
        public Constructor get() throws ClassNotFoundException, NoSuchMethodException {
    ...
    // this code's structure is based on Compressor's structure @see{org.apache.kafka.common.record.Compressor}
